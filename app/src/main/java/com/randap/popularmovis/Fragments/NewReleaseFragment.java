...
/**
 * Created by shenanigan on 20/9/16.
 */
...
//        });
    ...
    private void getMovieData() {
        ...
        Call<MovieResponse> call = apiService.getupcomingMovies(Secrets.API_KEY);
...
//                mMovieAdapter = new RecyclerImageAdapter(mContext, mMovieDetailList);
